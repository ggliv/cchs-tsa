...
<body>
	...
	<section class="hero is-dark is-bold">
		<div class="hero-body">
			<div class="container">
				<h1 class="title has-text-light">Our Music</h1>


				<h2 class="subtitle has-text-white">Take a look at some of the reliquaries of our holy vibrations.</h2>
			</div>
		</div>
	</section>

<section class="hero has-background-light is-fullheight is-bold"><br>
	<div class='page-content'>
		<div class="columns has-text-centered">
			<div class="column">
				<a href="resources/snd/ep"><img height="500" src="resources/img/uuoutline.png" width="500">

				<p style="text-align:center;">Unncessary Umlauts EP</p></a>
			</div>


			<div class="column">
				<a href="resources/snd/big"><img height="500" src="resources/img/bigumlauts.png" width="500">

				<p style="text-align:center;">Especially Big Umlauts</p></a>
			</div>


			<div class="column">
				<a href="resources/snd/oceans"><img src="resources/img/oceansofumlauts.png" width="500" height="500">
				<p style="text-align:center">Oceans of Umlauts</p></a>
			</div>
		</div>
	</div>
